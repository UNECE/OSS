...
format:
  html:
    toc: true
    toc-location: right
# The toc-location line here is to fix an issue where a psudo sidebar would appear, which is possibily related to not using the standard html theme in _quarto.yml
...
*Serbian National Statistical Institute*
...
-   **Advanced Reporting Capabilities**: IST supports real-time reporting in multiple formats, such as Excel, JSON, and XML, facilitating easy data dissemination.
