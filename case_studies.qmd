...
## **Building a FOSS ecosystem for statistical data processing** {#Data-Cleaning}
...
## **Adoption of OSS and governance efforts in Istat** {#Istat}
...
## **Building a community-driven OSS: The SIS-CC experience** {#SIS-CC}
...
## **Transforming a software into OSS at SORS** {#SORS}
...
## **Sharing OSS across communities - The Awesome List for Official Statistics Software** {#Awesome-List}
...
## **sdmx.io — an open-source SDMX ecosystem** {#sdmx-io}

*Bank for International Settlements (BIS)*

### Introduction

sdmx.io is an open-source ecosystem of software, guidance and learning resources dedicated to implementing the SDMX standard across the statistical lifecycle. Established under the [BIS Open Tech strategy](https://www.bis.org/innovation/bis_open_tech.htm), it reflects the principle that software can be treated as a public good. Rather than a single tool, sdmx.io brings together interoperable components that cover domain modelling, data collection, processing, validation and dissemination. The initiative is meant to improve interoperability and coherence in the SDMX space and with a wide set of community-driven solutions.
