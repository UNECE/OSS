---
title: "HLG-MOS Open-Source Software Charter for Official Statistics"
sidebar: false
format:
  html: 
    toc: true
  ...
  pdf:
    ...
    include-in-header: 
      text: |
        \usepackage{fancyhdr}
        \pagestyle{fancy}
        \fancyhead[C]{HLG-MOS Open-Source Software Charter for Official Statistics}
        \fancyhead[R]{}
        \fancyhead[L]{}
        \fancyfoot[C]{This work is licensed under a %
        \href{http://creativecommons.org/licenses/by/4.0/}{Creative Commons Attribution 4.0 International License}%
        }
    output-file: "HLG-MOS OSS Charter"
    output-ext:  "pdf"
---
