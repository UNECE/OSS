...
[^1]:   The principles were initially developed from ESS Principles on Open Source Software ([https://os4os.pages.code.europa.eu/pbbp/principles.html](https://os4os.pages.code.europa.eu/pbbp/principles.html)) and adjusted for the global context.