...
Further information on open source can be found on the [Open Source Initiative website](https://opensource.org/).

## **Project Origins: Who we are** {#who-we-are}
...
## **Strengths and weakness of open source for statistical organisations** {#strengths-and-weakness-of-open-source-for-statistical-organisations}
...
In the following section, we highlight the key strengths, weaknesses, opportunities, and threats of OSS in the context of statistical organisations. More detailed description of this analysis can be found in [Annex 2](#2:-swot-analysis-on-os-adoption-in-nsos). It is important to note that occasionally the **same factor can be both strength and weakness**, which highlights the importance of understanding their duality for making informed decisions and managing trade-offs as an organisation.
...
# **CES Endorsement** {#ces-endorsement}

The Conference endorses the Statistical Open Source Software Guiding Principles at the Seventy-third plenary session in Geneva, 16–18 June 2025.
The Principles were [amended](https://unece.org/sites/default/files/2025-06/OpenSourcePrinciples%20Amended.pdf) as described in document [ECE/CES/2025/9/Add.1](https://unece.org/sites/default/files/2025-06/ECE_CES_2025_9_Add.1_Open%20Source%20summary.pdf) after an e-consultation process in which CES member countries were invited to give their feedback on what was originally referred to as the "HLG-MOS Open Source Software Charter".

A brief summary of the e-consultation that was presented as the plenary session is [available](https://unece.org/sites/default/files/2025-06/8g_Open%20Source_Consultation%20Summary_UNECE.pdf).

The CES encourages countries to share and promote the Principles within their statistical systems.


# **Annexes** {#annexes}

## **1. Mapping between the OSS Guiding Principles and other frameworks** {#1:-mapping-between-the-oss-guiding-principles-and-other-frameworks}

| Principle                                     | [Fundamental Principles of Official Statistics](https://unstats.un.org/unsd/dnss/gp/FP-New-E.pdf)                                            | [UN NQAF Quality Principles 2019](https://unstats.un.org/unsd/methodology/dataquality/un-nqaf-manual/)                                                                                   | [EU-Open source strategy, 2020](https://ec.europa.eu/info/departments/informatics/open-source-software-strategy_en) |
|:-----------------|:-----------------|:-----------------|:-----------------|
...
: Table: OSS Frameworks {.striped .hover}

## **2. SWOT analysis on OS adoption in NSOs** {#2:-swot-analysis-on-os-adoption-in-nsos}
...
In 2009 [Oracle corporation](https://www.oracle.com/) proposed a takeover of Sun Microsystems.In 2010, the European Commission approved Oracle's acquisition of Sun, on the condition that Oracle continue to invest in [MySQL](https://www.mysql.com/) and keep it openly licensed.

The day Oracle announced the purchase of Sun, the main author of MySQL and founder of MySQL AB, Michael Widenius, forked MySQL, launching MariaDB; many MySQL developers followed him. MariaDB was created with the target to remain *free* and *open-source* under the GNU GPL licence. Over many years [MariaDB](https://www.mysql.com/) has grown as a product, maintaining compatibility with MySQL, while developing many new features and new engines, offering a fully managed cloud database service.

MariaDB became the new “M” in the [LAMP](https://en.wikipedia.org/wiki/LAMP_(software_bundle)) stack, and today is used by millions of users. It is the default database in most Linux distributions, and is available in every cloud.
...
### **Weakness and threats** {#weakness-and-threats}
...
As demonstrated in the [SIS-CC case study](case_studies.html#SIS-CC), open source software adoption requires legal considerations, particularly regarding licensing when developing and releasing the software or repurposing existing software. Legal expertise in statistical organisations has been typically focused on areas such as statistical law and data access, and expertise in open source license and managing issues arising from license is limited.
...
[^1]: <https://siscc.org/enhancing-sdmx-tools-interoperability-for-improved-organisational-efficiency/>
...
## **3. Open source and AI** {#3:-open-source-and-ai}
...
### **The OSI document** {#the-osi-document}

In the fall 2024, the Open Source Initiative (OSI) released the final version of “[The Open Source AI definition](https://opensource.org/ai/open-source-ai-definition)” which outlines the principles and requirements for defining Open Source Artificial Intelligence (AI).
...
### **Open source AI for NSOs** {#open-source-ai-for-nsos}
...
OSI released in December 2024 a [document](https://opensource.org/ai/open-source-ai-definition) with the aim of applying the principles of the [Open Source Definition](https://opensource.org/osd) in the domain of AI, trying to merge in Open Source AI different “openness” principles interacting with each other: Open Data with Open Source with Open Science and Open Knowledge.
